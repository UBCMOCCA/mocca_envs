...
class MikeStepperEnv(EnvBase):
    ...
    def __init__(self, render=False):
        ...
        if self.make_phantoms_yes:
            for _ in range(self.num_phantoms):
    ...
    def generate_step_placements(
        ...
        y_range = np.array([-20, -20]) * DEG2RAD
    ...
    def create_terrain(self):
        ...
        colours = [(1.0, 0.847, 0.694, 0), (0.882, 0.466, 0.001, 0)]
    ...
    def update_steps(self):
        ...
        print(self.next_step_index, threshold)
    ...
    def reset(self):
        ...
        self.robot_state = self.robot.reset(
            random_pose=False, pos=(0.3, 0, 1.), vel=[0.0, 0, 0]
        )
        self.base_phi = DEG2RAD * np.array(
            [-10] + [20, -20] * (self.n_steps // 2 - 1) + [10]
        )
    ...
    def step(self, action):
        ...
        if self.make_phantoms_yes and self.timestep % 57 == 0:
            ...
            self.current_phantom_idx %= self.num_phantoms
